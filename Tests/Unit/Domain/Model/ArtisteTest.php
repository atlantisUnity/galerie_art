...
{
    /**
     * @var \Qnvt\ExpositionQnvt\Domain\Model\Artiste
     */
    ...
    {
        parent::setUp();
        $this->subject = new \Qnvt\ExpositionQnvt\Domain\Model\Artiste();
    }
    ...
    {
        $nationalite = new \Qnvt\ExpositionQnvt\Domain\Model\Nationalite();
